...
<div class="wrapper">
    ...
    <div class="nav navbar-right" id="DinhHuong" style="transform:translateY(-35px)">
        <ul class="nav  pager">
            <li class="previous">
                <a href="?menu=dethi_list&amp;page1prev=&lt;?php echo $i?&gt; style=" background-color:#ffcccc"="">←Trước</a>
            </li>
            <li class="next"><a href="?menu=dethi_list&amp;page1=&lt;?php echo $i?&gt; style=" background-color:#ffcccc"="">Sau→</a></li>
            </ul>
        </div>
</div></body></html>