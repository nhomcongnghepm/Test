...
<div style="margin:20px 70px 10px; font-size:14px;">
    ...
    <form action="?menu=quanlydiemthi" method="post" class="">
        <br><table width="600" border="0"  cellpadding="0" cellspacing="0" background="../assets/image/body.png">
            <tr>
                <td bgcolor="#CCCCCC"  height="38px"colspan="3" align="center" class="style1">Tổng hợp điểm</td>
            </tr>
            <tr>
        ...
        <td colspan="3" style="padding: 10px 0px 10px 0px" align="center">
            <?php include '../controler/diemthi_pdt.php';?></td>
    </form>
</div>