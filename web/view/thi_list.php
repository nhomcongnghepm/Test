...
<?php 
		$tv3= "SELECT * FROM  tbl_cauhoi where made='Toán' LIMIT 0 , 10";
		$tv4 = $db->query($tv3);
		$cau=0;
                            ...
                            <div class=" panel panel-danger ">
                              ...
                              <div class="panel-body">
                                 ...
                                 <div class="input-group cauhoi">
                                    ...
                                    <div><input type="checkbox" name="<?php echo $rows3['ma_ch']; ?>" value="<?php echo $rows3['kc3']; ?>" onclick="ghiketqua(this.value,<?php echo $cau ?>)"> C: <?php echo $rows3['lc3']; ?></div>
