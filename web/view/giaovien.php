...
<head>
    ...
    <link href="../assets/giaovien/files/home/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="../assets/giaovien/files/home/data.js"></script>
...
<div id="base" class="">
        ...
        <div id="u0_state1" class="panel_state" data-label="Second slide" style="visibility: hidden;">
            <div id="u0_state1_content" class="panel_state_content">
                ...
                <div id="u1" class="ax_default image1">
                    <img id="u1_img" class="img " src="../assets/giaovien/images/home/u1.jpg"/>
                </div>
            </div>
        </div>
        <div id="u0_state2" class="panel_state" data-label="Third slide" style="visibility: hidden;">
            <div id="u0_state2_content" class="panel_state_content">
                ...
                <div id="u2" class="ax_default image1">
                    <img id="u2_img" class="img " src="../assets/giaovien/images/home/u2.jpg"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="u5" class="ax_default">
        <img id="u5_menu" class="img " src="../assets/giaovien/images/home/u5_menu.png" alt="u5_menu"/>
        ...
        <div id="u6" class="ax_default">
            ...
            <div id="u7" class="ax_default menu_item">
                <img id="u7_img" class="img " src="../assets/giaovien/images/home/u7.png"/>
                <div id="u7_text" class="text ">
                    <a href="?menu=dethi_list"> <p><span>GIÁO VIÊN</span></p></a>
                </div>
            </div>

            <!-- Unnamed (Menu Item) -->
            <div id="u8" class="ax_default menu_item">
                <img id="u8_img" class="img " src="../assets/giaovien/images/home/u8.png"/>
            ...
            <div id="u9" class="ax_default menu_item">
                <img id="u9_img" class="img " src="../assets/giaovien/images/home/u7.png"/>
            ...
            <div id="u10" class="ax_default menu_item">
                <img id="u10_img" class="img " src="../assets/giaovien/images/home/u10.png"/>
            ...
            <div id="u11" class="ax_default menu_item">
                <img id="u11_img" class="img " src="../assets/giaovien/images/home/u11.png"/>
            ...
            <div id="u12" class="ax_default menu_item">
                <img id="u12_img" class="img " src="../assets/giaovien/images/home/u12.png"/>
    ...
    <!-- Unnamed (SVG) -->
    <div id="u14" class="ax_default image1">
        <img id="u14_img" class="img " src="../assets/giaovien/images/home/u14.svg"/>
    </div>

    <!-- Unnamed (SVG) -->
    <div id="u15" class="ax_default image1">
        <img id="u15_img" class="img " src="../assets/giaovien/images/home/u15.svg"/>
    </div>

    <!-- Unnamed (SVG) -->
    <div id="u16" class="ax_default image1">
        <img id="u16_img" class="img " src="../assets/giaovien/images/home/u16.svg"/>
    </div>

    <!-- Unnamed (Image) -->
    <div id="u17" class="ax_default image">
        <img id="u17_img" class="img " src="../assets/giaovien/images/home/u17.png"/>
    </div>

    <!-- Unnamed (Rectangle) -->
    <div id="u18" class="ax_default heading_11">
    ...
    <!-- Unnamed (Rectangle) -->
    <div id="u19" class="ax_default heading_11">
    ...
    <div id="u20" class="ax_default image">
        <img id="u20_img" class="img " src="../assets/giaovien/images/home/u20.png"/>
    </div>

    <!-- Unnamed (Image) -->
    <div id="u21" class="ax_default image">
        <img id="u21_img" class="img " src="../assets/giaovien/images/home/u21.png"/>
    </div>

    <!-- Unnamed (Rectangle) -->
    <div id="u22" class="ax_default heading_11">
    ...
    <!-- Unnamed (SVG) -->
    <div id="u24" class="ax_default image1">
        <img id="u24_img" class="img " src="../assets/giaovien/images/home/u24.svg"/>
    </div>

    <!-- Unnamed (Rectangle) -->
    <div id="u25" class="ax_default box_1">
        <div id="u25_div" class=""><?php include ("../controler/giaovien.php")?></div>
    </div>
</div>
</body>
</html>
