...
<div class="wrapper">
    ...
    <div class="nav navbar-right" id="DinhHuong" style="transform:translateY(-35px)">
        <ul class="nav  pager">
            <li class="previous">
                <a href="?menu=xemdethi_list&&page1prev=<?php echo $i;?>" style=" background-color:#ffcccc"="">←Trước</a>
            </li>
            <li class="next"><a href="?menu=xemdethi_list&&page1=<?php echo $i;?>" style=" background-color:#ffcccc"="">Sau→</a></li>
        </ul>
    </div>
</div></body></html>